...
| **Motion sampling & event clips** (processor service)  | **Main** — same source as recording, so detection and clips align with what we would expect from the primary feed.                                                                                     |
